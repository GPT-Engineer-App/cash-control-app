...
FGostaria que você criasse uma interface de aplicativo móvel com as seguintes funcionalidades e páginas:
...
Integração com provedores externos de login (Google, Facebook, etc.)
...
Quanto à codificação, utilize React Native para desenvolvimento multiplataforma (iOS e Android). Integre com banco de dados para armazenar dados do usuário. Faça uso de animações e transições suaves. Otimize o aplicativo para performance e eficiência."
...
```sh
git clone https://github.com/GPT-Engineer-App/cash-control-app.git
cd cash-control-app
npm i
```
